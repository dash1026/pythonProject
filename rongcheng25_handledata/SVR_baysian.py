...
df_pred_day3.to_csv(os.path.join(output_dir, 'BESVR_predicted_values3.csv'), index=False)
df_pred_day4.to_csv(os.path.join(output_dir, 'BESVR_predicted_values4.csv'), index=False)
